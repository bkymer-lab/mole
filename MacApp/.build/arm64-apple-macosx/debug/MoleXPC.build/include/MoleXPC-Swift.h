...
#ifndef MOLEXPC_SWIFT_H
#define MOLEXPC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MoleXPC",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_PROTOCOL_NAMED("MoleHelperProtocol")
@protocol MoleHelperProtocol
- (void)executeTaskWithKind:(NSString * _Nonnull)kind reply:(void (^ _Nonnull)(BOOL, NSString * _Nullable))reply;
@end
